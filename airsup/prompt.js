...
function generatePrompt({
  ...
  return [
    ...
    '- look at that live directory when you need to find someone you do not already know. If I already named a person you know (for example “talk to Konstantin”) and you already have their endpoint email from before, just contact them. Do not reload the whole list every time.',
    '- you may remember people I already use: their name, endpoint_id, and email. If I ask you to find someone new, or a name is unknown, open the live directory then.',
    ...
    '',
    'Outgoing contact:',
    'If you already know this person’s ai_endpoint_email, send a brand-new Gmail message. If you need to find who to contact, open the live directory first.',
    ...
    'DIRECTORY',
    '',
    'Do not guess who is in the network. Do not use a plugin. Do not invent people.',
    'Open the live directory when you need to discover or match someone. Skip it when I name a person you already know and we do this often.',
    '',
    directory,
    '',
    ...
    '',
    'Correct flow when you need to find someone:',
