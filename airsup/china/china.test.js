...
assert.strictEqual(COPY.en.preview_lead, 'Enter the company website first.');
...
assert.ok(COPY.en.footer.toLowerCase().includes('tade mehl production'));
assert.ok(COPY.en.footer.includes('tademehl@gmail.com'));
assert.strictEqual(COPY.zh.footer, COPY.en.footer);
