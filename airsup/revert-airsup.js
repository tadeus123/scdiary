#!/usr/bin/env node
/**
 * Fully revert invisible Airsup / Supi discovery install.
...
console.log('\nAirsup discovery removed from app files.');
console.log('Review git diff, commit & push. Optional: delete airsup/ folder.');
